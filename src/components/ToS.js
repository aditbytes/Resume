    ...
    <div className="tos-container">
      ...
      <div className="tos-content">
        ...
        <section className="tos-section">
          <h2>4. Limitations</h2>
          <p>
            In no event shall Aditya or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on this website.
          </p>
        </section>
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            <a href="mailto:kraditya9241@gmail.com" className="tos-link"> kraditya9241@gmail.com</a>
          </p>
        </section>
      </div>
